/*
 * $Id: sbx_common.c,v 1.25 2012/03/02 16:01:16 yaronm Exp $
...
/*
 * Templates created for each user specified configuration. There are limited number
...
soc_sbx_connect_reload(int unit, uint32_t *util, uint32_t *age)
{
    ...
    for (index = 0; index < conn_util[unit]->max_template; index++) {
        ...
        /* FIXME: should set to DK_VERBOSE */
