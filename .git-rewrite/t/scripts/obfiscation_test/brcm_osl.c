/*
 * $Id: brcm_osl.c,v 1.7 2012/04/23 08:19:20 alai Exp $
...
#if defined(KEYSTONE) || defined(ROBO_4704) || defined(NORTHSTAR)
...
#endif /* defined(KEYSTONE) || defined(ROBO_4704) || defined(NORTHSTAR) */
